...
class AppDialog : AppCompatDialogFragment() {
    ...
    internal interface DialogEvents {
        fun onPositiveDialogResult(dialogId: Int, arg: Bundle)
//        fun onNegativeDialogResult(dialogId: Int, arg: Bundle)
//        fun onDialogCancel(dialogId: Int)
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        // fix "smart to Bundle is impossible, because 'arguments' is a mutable property that could have been changed by this time.
