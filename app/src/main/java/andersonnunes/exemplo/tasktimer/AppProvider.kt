...
const val CONTENT_AUTHORITY = "andersonnunes.exemplo.tasktimer.provider"
...
class AppProvider : ContentProvider(){
    ...
    private fun buildUriMatcher() : UriMatcher {
        ...
        //e.g. content://andersonnunes.exemplo.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS)

        //e.g. content://andersonnunes.exemplo.tasktimer.provider/Tasks/8
        matcher.addURI(CONTENT_AUTHORITY, "${TasksContract.TABLE_NAME}/#", TASKS_ID)

        matcher.addURI(CONTENT_AUTHORITY, TimingsContract.TABLE_NAME, TIMINGS)
        matcher.addURI(CONTENT_AUTHORITY, "${TimingsContract.TABLE_NAME}/#", TIMINGS_ID)
//
//        matcher.addURI(CONTENT_AUTHORITY, DurationsContact.TABLE_NAME, TASK_DURATIONS)
